...
// Obtención de noticias de negocios
$apiKey = getenv('API_KEY_NEWS'); 
$url = "https://gnews.io/api/v4/top-headlines?category=business&lang=es&country=mx&max=20&apikey=" . $apiKey;
...
if (isset($datos['articles']) && is_array($datos['articles'])) {
    ...
    echo "\nTotal de noticias de negocios procesadas: $insertados\n";
} else {
